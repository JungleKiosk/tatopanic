...
<template>
    ...
    <div>
        ...
        <!-- Barchetta che si muove -->
         <img class="boat" src="../assets/img/svg/boat.svg" alt="">
<!--         <svg class="boat" fill="#ffffff" x="100" y="0" width="30" height="30" viewBox="500 500 1000 1000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
